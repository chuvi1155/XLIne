...
public class Triangulator
{
    ...
    public Triangulator(List<Vector2> vertices)
    {
    ...
    public Triangulator(Vector2[] vertices)
    {
        ...
        vertexList = new List<Vector2>(vertices);
    ...
    {
        this.vertices = new List<Vector2>(vertices.Length);
        vertexList = new List<Vector2>(vertices.Length);
        for (int i = 0; i < vertices.Length; i++)
        {
